...
echo -e "${blue}${bold}${uline}[Phase 1 of 5]${reset}"
...
echo -e "${blue}${bold}${uline}[Phase 2 of 5]${reset}"
...
echo -e "${blue}${bold}${uline}[Phase 3 of 5]${reset}"
echo -e "${green}${bold}[Installing KivyMD dependencies]${reset}"
pip install Pillow
pip install kivy
echo " "

echo -e "${blue}${bold}${uline}[Phase 4 of 5]${reset}"
...
echo -e "${blue}${bold}${uline}[Phase 5 of 5]${reset}"
